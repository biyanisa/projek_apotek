...
class DrugController extends Controller
{
    ...
    public function store(DrugRequest $request)
    {
        ...
        return redirect('/drug')->with('created', 'Obat baru telah di tambahkan!');
    }
    ...
    public function update(DrugRequest $request, Drug $drug)
    {
        ...
        // kembali ke halaman drug sambil membawa session
        return redirect('/drug')->with('updated', 'Data Obat di perbarui!');
    }
    ...
    public function delete(Drug $drug)
    {
        ...
        return redirect()->to('/drug')->with('deleted', 'Data Obat di hapus!');
    }
}