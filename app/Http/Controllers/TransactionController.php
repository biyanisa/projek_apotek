...
class TransactionController extends Controller
{
    ...
    public function store(TransactionRequest $request)
    {
        ...
        return redirect('/transaction')->with('created', 'Transaksi baru telah di tambahkan!');
    }
    ...
    public function update(TransactionRequest $request, Transaction $transaction)
    {
        ...
        // kembali ke halaman transaction sambil membawa session
        return redirect('/transaction')->with('updated', 'Transaksi telah di updated!');
    }
    ...
    public function delete(Transaction $transaction)
    {
        ...
        return redirect()->to('/transaction')->with('deleted', 'Transaksi telah di hapus!');
    }
}
