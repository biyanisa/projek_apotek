...
class SupplierController extends Controller
{
    ...
    public function store(SupplierRequest $request)
    {
        ...
        return redirect('/supplier')->with('created', 'Pemasok baru btelah di tambahkan!');
    }
    ...
    public function update(SupplierRequest $request, Supplier $supplier)
    {
        ...
        // kembali ke halaman supplier sambil membawa session
        return redirect('/supplier')->with('updated', 'Pemasok telah di update!');
    }
    ...
    public function delete(Supplier $supplier)
    {
        ...
        return redirect()->to('/supplier')->with('deleted', 'Pemasok telah di hapus!');
    }
}
